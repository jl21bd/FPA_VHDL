...
HD_PWD='C:/Users/admin/workbench/playground/vivado/final/final.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log flower_pollination.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source flower_pollination.tcl
